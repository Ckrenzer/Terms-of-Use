...
tf_idf(text_df = unigram_counts, doc_id = "company", text_column = "text", counts_column = "n") %>% 
  rank_words_by_company(word_count_df = ., company_name =  "Amazon", rank_column = "tf_idf")
